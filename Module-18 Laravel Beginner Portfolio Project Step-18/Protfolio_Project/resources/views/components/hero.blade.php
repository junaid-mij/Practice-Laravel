        ...
        <div class="row gx-5 align-items-center">
            <div class="col-xxl-5">
                ...
                <div class="text-center text-xxl-start">
                    ...
                    <div class="fs-3 fw-light text-muted" id="sort_title">I can help your business to</div>
            ...
            <div class="col-xxl-7">
                <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                    <div class="profile">
                        <img class="profile-img" id="profileImage" src="assets/profile.png" alt="..." />
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    async function GetHeroSection() {
        ...
        try {
            ...
            document.getElementById('sort_title').innerHTML = response.data['sort_title'];
            document.getElementById('title').innerHTML = response.data['title'];
            document.getElementById('profileImage').src = response.data['img'];

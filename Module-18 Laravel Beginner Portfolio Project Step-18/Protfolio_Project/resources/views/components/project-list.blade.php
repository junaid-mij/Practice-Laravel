                    ...
                    <div class="card-body p-0">
                        <div class="d-flex align-items-center">
                            <div class="p-5">
                                ...
                                <p>${item['details']}</p>
                                <a class="btn btn-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder" target="_blank" href="${item['previewLink']}">View Project</a>
                            </div>
                            <img class="img-fluid" src="${item['thumnailLink']}" alt="..." />
                        </div>
                    </div>
                </div>
                `);
